...
A self-contained, browser-based workspace for thinkers, builders, and creators.
No accounts. No installs. No cloud dependency.
...
🎵 **Music Player** — Paste any YouTube video or playlist URL and listen while you work
 ...
 🟰 **LaTeX** - Render math equations that are supported by KaTeX and LaTeX
